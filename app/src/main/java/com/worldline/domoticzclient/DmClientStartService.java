...
public class DmClientStartService extends Service {
    private final String TAG = "DmClientStartService";
    @Nullable
    @Override
    ...
    private final SpicaServiceConnectionCallback<MsmdService> connectionCallback = new SpicaServiceConnectionCallback<MsmdService>() {
        ...
        public void onConnect(MsmdService msmdService) {
            ...
            Intent intentAct = new Intent(DmClientStartService.this, MainActivity.class);
